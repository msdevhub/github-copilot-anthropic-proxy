...
export const PORT = Number(process.env.PORT) || 4819;
...
export const DB_PATH = process.env.DB_PATH || join(__DIR, "proxy-logs.db");
...
// mask("abcdefghijklmnop") → "abcd…mnop"; very short strings collapse to "***".
